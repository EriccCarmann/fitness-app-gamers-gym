...
class ChestStretchDoorActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_chest_stretch_door)
        ...
        lowIntensivity.text= Html.fromHtml(
            "<font color=${Color.BLACK}>При <u>низкой интенсивности</u> — от 1 до 2</font>"
        )

        highIntensivity.text= Html.fromHtml(
            "<font color=${Color.BLACK}>При <u>высокой интенсивности</u> — от 2 до 4</font>"
        )
    }
}