...
class CatterpillarActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_catterpillar)
        ...
        lowIntensivity.text= Html.fromHtml(
            "<font color=${Color.BLACK}>При <u>низкой интенсивности</u> — от 1.7 до 3.4</font>"
        )

        highIntensivity.text= Html.fromHtml(
            "<font color=${Color.BLACK}>При <u>высокой интенсивности</u> — от 1.7 до 6.9</font>"
        )
    }
}