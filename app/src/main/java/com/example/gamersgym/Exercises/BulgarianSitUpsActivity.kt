...
class BulgarianSitUpsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_bulgarian_sit_ups)
        ...
        highIntensivity.text= Html.fromHtml(
            "<font color=${Color.BLACK}>При <u>высокой интенсивности</u> — от 2.4 до 8</font>"
        )
    }
}